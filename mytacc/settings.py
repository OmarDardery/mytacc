"""
Django settings for mytacc project.
...
SECRET_KEY = 'django-insecure-1&+m%kyg5p$auy$#rg%mz@_u)-49j536k343a5^$6p6fap=un3'
...
WSGI_APPLICATION = 'mytacc.wsgi.application'
