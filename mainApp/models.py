...
class User(AbstractUser):
    username = models.CharField(max_length=15, blank=False, unique=True, error_messages={"unique": "This ID has already been used.", 'blank': "This field cannot be blank."}, validators=[MaxLengthValidator(15), MinLengthValidator(7)])
